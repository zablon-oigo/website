...
export declare function createControl({ label, isActive, operation, icon, isDisabled, }: CreateControlProps): React.ForwardRefExoticComponent<RichTextEditorControlBaseProps & React.RefAttributes<HTMLButtonElement>>;
